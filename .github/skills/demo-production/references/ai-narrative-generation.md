...
- **Audience unstated or vague** ("make a demo", no named audience) — **ask**: *"Who is this
  ...
  point of Step 1's research is that different audiences want different facts, and a guess
  here compounds into every later step.
...
write next, or just as a chat response if there's no repo to write into at all (a live URL,
a summary-only ask). Ask if it's genuinely unclear where it should live. Keep it to exactly
these sections — this is a working script, not a marketing doc:
