...
| **Deal brief + IC readiness** | Faster, defensible IC prep | Verdict + top blockers + “what changed since last check” + one-click resolve, all from real gating facts — not a progress bar |
