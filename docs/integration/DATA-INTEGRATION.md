...
>
> See also: [Access model](../ACCESS-MODEL.md) · [Data sovereignty](../security/DATA-SOVEREIGNTY.md) ·
...
- **Sovereignty boundary.** External providers are **external-data**; the data-sovereignty guard
  ([DATA-SOVEREIGNTY.md](../security/DATA-SOVEREIGNTY.md)) prevents internal deal context from leaking to a
