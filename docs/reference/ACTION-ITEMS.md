...
> cost/ops in [OPERATIONS-PLAN.md](../operations/OPERATIONS-PLAN.md); agent data-sovereignty
> model in [DATA-SOVEREIGNTY.md](../security/DATA-SOVEREIGNTY.md).
...
| F1 · agent + skills docs | ✅ done — [AGENTS.md](../integration/AGENTS.md) |
...
already shipped (see [DATA-SOVEREIGNTY.md](../security/DATA-SOVEREIGNTY.md) and
...
1. **Adopt the *skills* into our persona instructions (S, do first).** Skills are markdown
   ...
   [AGENTS.md](../integration/AGENTS.md) / [personas.js](../../app/data/personas.js):
...
- **Direction (delivered):** moved from **persona** agents (one per role, much overlap) to the
  **purpose** agents (Sourcing · Screening · Diligence · Modeling · IC-Memo · Value-Creation)
  ...
  [AGENTS.md § Purpose-based agents](../integration/AGENTS.md).
