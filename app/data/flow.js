...
export const STEPS = [
  {
    ...
    code: 'O1',
    title: 'Deal Sourcing',
    why: 'Find the few targets worth pursuing — before competitors do.',
  ...
  },
  {
    ...
    code: 'O2',
    title: 'Auto Screen',
    why: 'Focus the team only on opportunities that genuinely fit the mandate — no time wasted on the rest.',
  ...
  },
  {
    ...
    code: 'O3',
    title: 'Triage',
    why: 'Know early whether a target can clear IC, and roughly what it’s worth, before spending diligence dollars.',
  ...
  },
  {
    ...
    why: 'Commit the firm’s time and capital only to deals with a credible path to a return.',
  ...
  },
  {
    ...
    stage: 'diligence',
    code: 1,
    title: 'Set up the deal workspace',
    why: 'Get the whole deal team working from day one — not after a week of setup.',
    what: 'On "pursue", the deal lead requests the deal workspace, prepares templates and assigns ownership across the diligence workstreams.',
    agent: 'Diligence planning',
    inputs: ['Screening decision', 'DD playbook', 'Comparable deals'],
    produces: ['Deal workspace (Teams + SharePoint)', 'DD checklist & templates', 'Workstream owners assigned'],
  ...
  },
  {
    ...
    code: 2,
    title: 'Diligence',
    why: 'Surface the risks and upside that actually decide the deal — with every workstream working from the same facts.',
    what: 'The team conducts diligence in their workstreams — commercial, tech / AI and operations — in parallel, each supported by its own orchestrated agents on the shared record.',
    agent: 'One assistant per workstream',
    ...
    m365Action: 'Workstream collaboration across Teams, Excel & PowerPoint',
    owner: 'Lead MD',
  ...
  },
  {
    ...
    code: 3,
    title: 'Synthesis',
    why: 'Give the IC one clear, consistent story to decide on — no reconciling conflicting numbers.',
  ...
  },
  {
    ...
    why: 'A clean, defensible go/no-go the firm can stand behind — with compliance covered.',
  ...
  },
  {
    ...
    why: 'Lock in the capital structure that maximises returns and holds up against the IC case.',
  ...
  },
  {
    ...
    code: 2,
    title: 'Signing (SPA)',
    why: 'Protect the firm’s downside in the terms before you’re committed.',
  ...
  },
  {
    ...
    code: 3,
    title: 'Closing',
    why: 'Reach a clean ownership transfer with no surprises at completion.',
  ...
  },
  {
    ...
    why: 'Start creating value from day one of ownership, with nothing lost in the handover.',
    ...
    agent: 'Value-creation onboarding',
  ...
  },
  {
    ...
    why: 'Deliver the value-creation thesis the return depends on.',
  ...
  },
  {
    ...
    why: 'Catch issues early and keep the board and LPs confident with a clear view of performance.',
  ...
  },
  {
    ...
    code: 3,
    title: 'Exit',
    why: 'Realise the return for LPs at the best achievable value and timing.',
...
export const LIFECYCLE = [
  ...
  {
    num: 4, phase: 'origination', id: 'pursue', kind: 'gate', name: 'Go / no-go — PURSUE',
    owner: 'partner', personas: ['partner'],
    summary: 'The sponsor records PURSUE on the decision-ready shortlist, committing the deal team and spinning up the collaboration space.',
  ...
  },
  {
    ...
    produces: ['QoE report', 'Workstream findings', 'Risk register'], mapsToSteps: ['D1', 'D2'],
  },
  {
  ...
  },
  {
    ...
    summary: 'Assess exit readiness and run a dual-track (M&A / IPO) realisation; attribute returns (IRR / MOIC) back to the thesis.',
    produces: ['Exit readiness', 'Realisation', 'Returns attribution (IRR / MOIC)'], mapsToSteps: [],
  },
];
