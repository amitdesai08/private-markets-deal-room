...
export const WORKIQ_SEED_NOTES = [
  ...
  { id: 'wiq-seed-helv-1', dealId: 'helvetia', author: 'Dr. Priya Nair', personaId: 'ai-md', personaLabel: 'AI Partner — Tech & Digital Value', role: 'deal-team',
  ...
  { id: 'wiq-seed-helv-2', dealId: 'helvetia', author: 'Diego Marquez', personaId: 'supply-md', personaLabel: 'Supply Chain Partner — Operations', role: 'deal-team',
  ...
  { id: 'wiq-seed-helv-3', dealId: 'helvetia', author: 'David Osei', personaId: 'fund-cfo', personaLabel: 'Finance Partner — Fund CFO', role: 'deal-team',
  ...
  { id: 'wiq-seed-meridian-1', dealId: 'meridian', author: 'Dr. Priya Nair', personaId: 'ai-md', personaLabel: 'AI Partner — Tech & Digital Value', role: 'deal-team',
  ...
  { id: 'wiq-seed-meridian-2', dealId: 'meridian', author: 'Rachel Nguyen', personaId: 'operating-partner', personaLabel: 'Operating Partner — Value Creation', role: 'deal-team',
  ...
  { id: 'wiq-seed-sterling-1', dealId: 'sterling', author: 'James Whitfield', personaId: 'retail-md', personaLabel: 'Commercial Partner — Sector & Growth', role: 'deal-team',
...
const CHANNELS = [
  { deal: 'helvetia', channel: 'Helvetia Diagnostics — Deal Room', messages: [
  ...
  { deal: 'meridian', channel: 'Meridian Logistics — Value Creation', messages: [
...
const FILES = [
  { deal: 'helvetia', name: 'Helvetia — Supply Risk & Dual-Sourcing Memo.docx', type: 'driveItem', summary: 'Reagent concentration 68% two-vendor; Vendor B qualification +6% / 8-wk; tariff exposure.', lastModified: '2026-07-24T14:38:00Z' },
  { deal: 'helvetia', name: 'Helvetia — Sources & Uses + Debt Term Sheet.xlsx', type: 'driveItem', summary: '$384M senior at ~4.2x; sponsor equity; CHF/EUR hedge; base/downside returns.', lastModified: '2026-07-26T11:00:00Z' },
  ...
  { deal: 'sterling', name: 'Project Sterling — Commercial DD (Merchant Concentration).pptx', type: 'driveItem', summary: 'Top-10 merchant 34% of net revenue; largest contract renewal in 14 months; pricing power.', lastModified: '2026-07-25T13:25:00Z' },
  { deal: 'meridian', name: 'Meridian — Route Optimisation Pilot Results.xlsx', type: 'driveItem', summary: 'Midwest lane empty-miles -7%; fleet-wide scale case; telematics data dependency.', lastModified: '2026-07-27T09:50:00Z' },
];

// Mailbox — banker / LP / advisor correspondence.
const MAIL = [
  { deal: 'helvetia', subject: 'Helvetia — revised debt commitment + hedge indication', from: 'coverage@lead-bank.example', received: '2026-07-26T10:40:00Z', preview: 'Attaching the updated senior commitment ($384M, ~4.2x) and an indicative CHF/EUR hedge. Happy to walk the covenant headroom on a call.' },
  { deal: 'helvetia', subject: 'LP query — SFDR / ILPA reporting for Helvetia', from: 'ir@northstar-lp.example', received: '2026-07-28T08:05:00Z', preview: 'Ahead of the quarter, could you confirm the SFDR classification and the ILPA-aligned reporting template you\'ll use for this position?' },
  ...
  { deal: 'sterling', subject: 'Project Sterling — top merchant renewal timeline', from: 'partner@advisor.example', received: '2026-07-25T12:15:00Z', preview: 'Confirmed the largest merchant contract renews in ~14 months. Recommend making a pre-signing renewal discussion a condition.' },
];
...
export function seedChannelResult({ team_id, channel_id, query, top = 15 } = {}) {
  ...
  // Falling back to CHANNELS[0] handed EVERY deal the first seeded channel: a $240M Dublin
  // SaaS deal and a cold-chain 3PL both showed Helvetia Diagnostics' war room, complete with
